...
export default function ButtonDarkLight() {
    ...
    return(colorMode==='dark')?<ButtonMode onClick={modeChange} ><svg width="22" height="22" fill="#6a9955" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    </svg></ButtonMode>:<ButtonMode onClick={modeChange} ><svg width="22" height="22" fill="#6a9955" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
